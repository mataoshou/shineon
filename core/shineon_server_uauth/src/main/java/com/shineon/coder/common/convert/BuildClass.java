...
public class BuildClass {
	...
	public void buildBase(String className,File root,String pojo,List<MapperItem> items) throws Exception
	{
		...
		classBuildUtil.classInit(className,null, ConvertsConstant.BASE_PACKAGE,null,true,
				...
				"java.util.ArrayList","java.util.List","org.springframework.beans.factory.annotation.Autowired","com.shineon.coder.convert.CommonItemUtils",
				"com.shineon.coder.convert.CommonItem","org.slf4j.Logger","org.slf4j.LoggerFactory");
