	...
	<body>
		...
		<div class="sys-center-show" style="background: #00F7DE;height: 180px; width: 700px;margin-left: 400px;margin-bottom:5px;padding: 30px;padding-top: 10px;">
			...
			<div class="util-content">
				...
				<select style="width: 450px;height: 30px;" class="sys-util">
			...
			<div class="pojo-content">
				...
				<select style="width: 450px;height: 30px;" class="sys-pojo">
			...
			<div class="sys-content">
				...
				<select style="width: 450px;height: 30px;" class="sys-name">
			...
			<div class="method-content">
				...
				<input  style="width: 445px;height: 30px;" class="class-method" value="get,edit,list"/>
		...
		<script>
			...
			MT.build_urls = ["/sys/oper/api","/sys/oper/feign","/sys/oper/db","/sys/oper/convert"]
